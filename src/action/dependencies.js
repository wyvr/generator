...
import { FOLDER_GEN_ROUTES, FOLDER_GEN_PLUGINS, FOLDER_GEN_SRC, FOLDER_GEN_EVENTS, FOLDER_GEN_COMMANDS, FOLDER_GEN_PAGES } from '../constants/folder.js';
...
export async function dependencies() {
    ...
    await measure_action(name, async () => {
        ...
        const data = [].concat(
            ...
            collect_files(Cwd.get(FOLDER_GEN_PAGES))
        );
