...
const wyvr_debug_clear_storage = document.getElementById('wyvr_debug_clear_storage');
if (wyvr_debug_clear_storage) {
    wyvr_debug_clear_storage.addEventListener('click', (e) => {
