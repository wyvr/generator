...
export const FOLDER_WYVR = 'wyvr';
export const FOLDER_GEN_WYVR = join(FOLDER_GEN, FOLDER_WYVR);
export const FOLDER_MEDIA = 'media';
export const FOLDER_RELEASES = 'releases';
export const FOLDER_STORAGE = 'storage';
export const FOLDER_LIST_PACKAGE_COPY = [FOLDER_SRC, FOLDER_ASSETS, FOLDER_ROUTES, FOLDER_PLUGINS, FOLDER_EXEC, FOLDER_WYVR];
