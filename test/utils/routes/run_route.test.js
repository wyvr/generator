...
describe('utils/routes/run_route', () => {
    ...
    it('show all data', async () => {
        ...
        deepStrictEqual(
            html,
            '{"request":{"url":"/test/10?a=b&c","method":"GET"},"response":{"uid":"0000"},"params":{"id":"10","isExec":true},"headers":{"visitor_languages":[]},"cookies":{},"query":{"a":"b","c":true},"body":{},"files":{},"data":{"$uid":"0000","$route":{"match":"^\\\\/test/([^\\\\]]*)$","methods":["get"],"mtime":0,"params":["id"],"path":"/home/p/wyvr/generator/test/utils/routes/_tests/run/show_all.js","rel_path":"/home/p/wyvr/generator/test/utils/routes/_tests/run/show_all.js","url":"/test"},"url":"/test"},"isProd":true}'
        );
        deepStrictEqual(log, [
    ...
    it('JSON in query parameters', async () => {
        ...
        deepStrictEqual(
            html,
            '{"request":{"url":"/test/10?conditions=%5B%7B%22attribute%22%3A%22sale%22%2C%22operator%22%3A%22%3D%3D%22%2C%22value%22%3A%221%22%7D%5D&amount=10","method":"GET"},"response":{"uid":"0000"},"params":{"id":"10","isExec":true},"headers":{"visitor_languages":[]},"cookies":{},"query":{"conditions":"[{\\"attribute\\":\\"sale\\",\\"operator\\":\\"==\\",\\"value\\":\\"1\\"}]","amount":"10"},"body":{},"files":{},"data":{"$uid":"0000","$route":{"match":"^\\\\/test/([^\\\\]]*)$","methods":["get"],"mtime":0,"params":["id"],"path":"/home/p/wyvr/generator/test/utils/routes/_tests/run/show_all.js","rel_path":"/home/p/wyvr/generator/test/utils/routes/_tests/run/show_all.js","url":"/test"},"url":"/test"},"isProd":true}'
        );
        deepStrictEqual(log, [
            ['⚠', '[route] returnJSON can only be used in onExec'],
        ]);
