...
describe('utils/pages/execute_page', () => {
    ...
    it('markdown file', async () => {
        deepStrictEqual(await execute_page(mockPage('pages/markdown.md', undefined, root)), [
            {
                content:
    ...
    it('markdown file empty', async () => {
        deepStrictEqual(await execute_page(mockPage('pages/markdown_empty.md', undefined, root)), undefined);
        deepStrictEqual(log, []);
    });
    it('js file, object', async () => {
        deepStrictEqual(await execute_page(mockPage('pages/static.js', undefined, root)), [
            {
                url: '/url',
            },
        ]);
    ...
    it('js file, array', async () => {
        deepStrictEqual(await execute_page(mockPage('pages/array.js', undefined, root)), [
            {
                url: '/url',
            },
        ]);
    ...
    it('js function file, object', async () => {
        deepStrictEqual(await execute_page(mockPage('pages/func.js', undefined, root)), [
            {
                url: '/url',
            },
        ]);
    ...
    it('js function file, array', async () => {
        deepStrictEqual(await execute_page(mockPage('pages/func_array.js', undefined, root)), [
            {
                url: '/url',
            },
        ]);
    ...
    it('js file, empty', async () => {
        deepStrictEqual(await execute_page(mockPage('pages/empty.js', undefined, root)), undefined);
        deepStrictEqual(log, []);
    });
    it('js file, undefined', async () => {
        deepStrictEqual(await execute_page(mockPage('pages/undefined.js', undefined, root)), undefined);
        deepStrictEqual(log, []);
    });
    it('js file, error', async () => {
        deepStrictEqual(await execute_page(mockPage('pages/error.js', undefined, root)), undefined);
        deepStrictEqual(log, [
