...
module.exports = {
    compile(filename) {
        ...
        const client_compiled = compiler.compile(content, {
            filename,
            dev: true,
            hydratable: true
        });
        console.log(client_compiled)
        const hydrate = null;//eval(client_compiled.js.code);
        return { filename, compiled, component, result: null, notes: [], hydrate };
    },
