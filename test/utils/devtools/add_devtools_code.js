...
describe('utils/devtools/add_devtools_code', () => {
    ...
    it('prod mode', () => {
        ...
        const result = add_devtools_code('<html><body></body></html>', './_tests/index.html', {});
        Env.value = undefined;
    ...
    it('contains debug script with data', () => {
        Env.set(EnvType.dev);
        const result = add_devtools_code('<html><body></body></html>', './_tests/index.html', {_wyvr: {identifier:'a-b-c'}});
        Env.value = undefined;
