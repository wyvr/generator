// @see https://github.com/sveltejs/svelte/issues/4694#issuecomment-637434624
/*
...
const base_file = 'node_modules/svelte/compiler.js'; // "type": "commonjs"
...
estree_walk(ast, {
    enter: function (node, parent, prop, index) {
        ...
        if (node.type !== 'CallExpression' || node.callee === undefined || node.callee.property === undefined || node.callee.property.name !== funcName) {
            return;
        }
        ...
        if (replaceMethod == 'spread') {
            ...
            code.overwrite(pushProp.start - 1, pushProp.start + pushPropLen + 1, ' /* PATCHED */ = [...' + arrayName + ', ');
        ...
        if (replaceMethod == 'concat') {
            // push --> assign concat
            // ".push" --> " = array.concat"
            code.overwrite(pushProp.start - 1, pushProp.end, ' /* PATCHED */ = ' + arrayName + '.concat');
